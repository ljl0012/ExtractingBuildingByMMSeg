...
data = dict(
    ...
    train=dict(
        ...
        split=
        '/media/home/jianlong.li/ljl/data/Extractbuildingdata/data/train/train.txt'
    ),
    val=dict(
        type='myDataset',
        data_root='',
        ...
        split=
        '/media/home/jianlong.li/ljl/data/Extractbuildingdata/data/val/val.txt'
    ),
    test=dict(
        type='myDataset',
        data_root='',
...
log_level = 'INFO'
load_from=None
# load_from = '/media/home/jianlong.li/ljl/data/Extractbuildingdata/upernet_swin_base_patch4_window12_512x512_160k_ade20k_pretrain_384x384_22K_20210531_125459-429057bf.pth'
resume_from = '/media/home/jianlong.li/ljl/data/Extractbuildingdata/work/tutorial/iter_20000.pth'
workflow = [('train', 1)]
...
work_dir = '/media/home/jianlong.li/ljl/data/Extractbuildingdata/work/tutorial'
seed = 42
gpu_ids = range(0, 4)
